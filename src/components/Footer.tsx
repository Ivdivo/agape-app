        ...
        <View className="bg-white pt-24 pb-12 px-6 border-t border-gray-100">
            <View className="max-w-[1400px] mx-auto">
                <View className="flex-row flex-wrap justify-between mb-20">
                    <View className="w-full lg:w-1/4 mb-14 lg:mb-0">
                        <Text className="text-3xl font-roboto-black tracking-tighter text-black uppercase mb-8">agápē</Text>
                        <View className="flex-row gap-6">
                            <TouchableOpacity activeOpacity={0.7}><Instagram size={22} color="black" strokeWidth={1.5} /></TouchableOpacity>
                            <TouchableOpacity activeOpacity={0.7}><Twitter size={22} color="black" strokeWidth={1.5} /></TouchableOpacity>
                            <TouchableOpacity activeOpacity={0.7}><Facebook size={22} color="black" strokeWidth={1.5} /></TouchableOpacity>
                            <TouchableOpacity activeOpacity={0.7}><Youtube size={22} color="black" strokeWidth={1.5} /></TouchableOpacity>
                        </View>
                    </View>
