            ...
            <View className="max-w-[1440px] mx-auto px-6">
                <View className="flex-row flex-wrap lg:flex-nowrap items-center">
                    <View className="w-full lg:w-1/2 mb-12 lg:mb-0 lg:pr-16">
                        ...
                        <Text className="text-white text-5xl lg:text-7xl font-roboto-black uppercase tracking-tighter leading-none mb-8">
                            The Science of Stillness
                        </Text>
                        <Text className="text-gray-400 text-lg font-roboto-regular leading-relaxed mb-10">
                        ...
                        <TouchableOpacity className="bg-white px-8 py-4 rounded-full self-start flex-row items-center">
                    ...
                    <View className="w-full lg:w-1/2 aspect-video bg-gray-900 rounded-[32px] overflow-hidden">
                        ...
                        <View className="absolute inset-0 items-center justify-center">
                            <View className="w-20 h-20 rounded-full bg-white/20 backdrop-blur-md items-center justify-center border border-white/30">
